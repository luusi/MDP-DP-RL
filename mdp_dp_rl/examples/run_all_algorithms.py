...
from mdp_dp_rl.algorithms.dp.dp_numeric import DPNumeric
from mdp_dp_rl.algorithms.adp.adp import ADP
...
if __name__ == '__main__':
    ...
    from mdp_dp_rl.examples.inv_control import InvControl
